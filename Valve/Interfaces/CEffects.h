...
public:
	...
	// Apply decal
	virtual void DecalShoot(int textureIndex, int entity, const model_t* model, const Vec& model_origin, const QAngle& model_angles, const Vec& position, const Vec* saxis, int flags) = 0;

	// Apply colored decal
	virtual void DecalColorShoot(int textureIndex, int entity, const model_t* model, const Vec& model_origin, const QAngle& model_angles, const Vec& position, const Vec* saxis, int flags, const color32& rgbaColor) = 0;

	virtual void PlayerDecalShoot(IMaterial* material, void* userdata, int entity, const model_t* model, const Vec& model_origin, const QAngle& model_angles, const Vec& position, const Vec* saxis, int flags, const color32& rgbaColor) = 0;
