...
enum ImGuiTreeNodeFlags_
{
    ...
    //ImGuiTreeNodeFlags_NoScrollOnOpen     = 1 << 14,  // FIXME: TO DO: Disable automatic scroll on TreePop() if node got just open and contents is not visible
...
enum ImGuiHoveredFlags_
{
    ...
    //ImGuiHoveredFlags_AllowWhenBlockedByModal     = 1 << 4,   // Return true even if a modal popup window is normally blocking access to this item/window. FIXME-TO DO: Unavailable yet.
